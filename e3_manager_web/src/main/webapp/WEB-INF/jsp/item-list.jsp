...
<div id="itemEditWindow" class="easyui-window" title="编辑商品" data-options="modal:true,closed:true,iconCls:'icon-save',href:'/item/item-edit'" style="width:80%;height:80%;padding:10px;">
</div>
<script>
