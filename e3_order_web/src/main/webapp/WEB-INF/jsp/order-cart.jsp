...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
	...
	<input type="hidden" name="orderShipping.receiverName" value="王金鑫"/>
	<input type="hidden" name="orderShipping.receiverMobile" value="18855466306"/>
	<input type="hidden" name="orderShipping.receiverState" value="安徽"/>
	<input type="hidden" name="orderShipping.receiverCity" value="淮南"/>
	<input type="hidden" name="orderShipping.receiverDistrict" value="田家庵区"/>
	<input type="hidden" name="orderShipping.receiverAddress" value="安徽省淮南市田家庵区安徽理工大学山南校区"/>
</form>
  ...
  <div id="userAddrId" class="orderTbody ">
    ...
    <div class="orderItem">
        <div class="orderCurr" id="userAddress" style="display:block;">
          <ul>
            <li>王金鑫&nbsp;&nbsp;&nbsp;&nbsp;18855466306&nbsp;&nbsp;&nbsp;&nbsp;淮南市&nbsp;&nbsp;田家庵区&nbsp;&nbsp;安徽理工大学山南校区</li>
          </ul>
        </div>
    </div>
  </div>
